...
(function(){
  ...
  function buildLead(row, idx, headers){
    ...
    const base = {
      ...
      updatedAt, lastUpdate:updatedAt, importedFromSheet:true, importSource:"admin_sheet_clean_import_v46"
    };
    const problems = [];
  ...
  function injectCss(){
    if(document.getElementById("mzj-sheet-import-v47-style")) return;
    const st=document.createElement("style"); st.id="mzj-sheet-import-v47-style"; st.textContent=`
