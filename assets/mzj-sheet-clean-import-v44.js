...
(function(){
  ...
  function buildLead(row, idx, headers){
    ...
    const base = {
      ...
      updatedAt, lastUpdate:updatedAt, importedFromSheet:true, importSource:"admin_sheet_clean_import_v44"
    };
    const problems = [];
  ...
  function injectCss(){
    if(document.getElementById("mzj-sheet-import-v44-style")) return;
    const st=document.createElement("style"); st.id="mzj-sheet-import-v44-style"; st.textContent=`
